...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Transaksi Tabungan Reguler</h1>
    @canany(['administrasi', 'admin'])
    <form action="/dashboard/transaksi-tabungan/bunga-reguler" method="get">
        <button class="btn btn-primary" type="submit" onclick="return confirm('apakah anda yakin melakukan penambahan bunga tabungan kepada setiap tabungan reguler nasabah ? ?')">Transaksi Penambahan Bunga</button>
    </form>
    @endcanany
...
<div class="col-lg-8">
    <form method="post" action="">
        ...
        {{ csrf_field() }}
        <div class="mb-3">
            <input id="jenis" type="hidden" value="reguler" name="jenis">
