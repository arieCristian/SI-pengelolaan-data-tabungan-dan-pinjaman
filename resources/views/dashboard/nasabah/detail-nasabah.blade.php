...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <a class="btn me-2 btn-warning" href="/dashboard/data-nasabah/{{ Crypt::encrypt($nasabah->id) }}/edit">Edit Nasabah</a>
        @endcanany --}}
...
<div class="col-lg-8">
    ...
    <div class="card p-3 mb-4 mt-4">
        <p class="fw-2 fw-bolder">Informasi Tabungan dan Pinjaman Nasabah</p>
        @if (count($tabungan) > 0)
